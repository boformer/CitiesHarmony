...
It also hotpatches older Harmony versions (1.2.0.1) that are still used by various mods. This is necessary because Harmony 1.x is incompatible with 2.x.
...
To use Harmony 2.x in your mod, add the `Lib.Harmony` nuget package to your project. Make sure that the `0Harmony.dll` is **not** copied to the output directory when you build your mod.
